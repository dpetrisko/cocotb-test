...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    // Body
    tracep->declBus(c+1,0,"q",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+6,0,"d",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelf->q),4);
    bufp->fullBit(oldp+2,(vlSelf->clk));
    bufp->fullCData(oldp+3,(vlSelf->d),4);
    bufp->fullCData(oldp+4,(vlSelf->dff__DOT__q),4);
    bufp->fullBit(oldp+5,(vlSelf->dff__DOT__clk));
    bufp->fullCData(oldp+6,(vlSelf->dff__DOT__d),4);
}
